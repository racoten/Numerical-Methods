function [xr,y] = false_position_method_project1(func)
  ...
  title('Convergence of the False Position Method - Root');
  xlabel('Iteration');
  ...
  title('Convergence of the False Position Method - Error');
  xlabel('Iteration');
